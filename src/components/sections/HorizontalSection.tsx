...
export function HorizontalSection({ 
  ...
  return (
    <motion.section
      ...
      className="py-16 px-8 border-t border-gray-800/50"
    >
        ...
        <div className="relative">
          <div className="flex gap-6 overflow-x-auto scrollbar-hide pb-4">
            ...
            {hasMoreItems && seeAllLink && (
              ...
              >
                <Link href={seeAllLink}>
                  <div className="h-full bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-700 rounded-lg p-8 hover:border-red-600/30 transition-all duration-300 cursor-pointer group flex items-center justify-center">
